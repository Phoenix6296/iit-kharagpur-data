...
class QLearningAgent:
    ...
    def run_episode(self):
        """Run one episode (with Q-learning updates) and return total reward."""
...
if __name__ == '__main__':
    # Quick demo for Q-Learning
    env = RoomCleaningEnv(grid_size=10, max_steps=100, num_obstacles=5)
    agent = QLearningAgent(env, alpha=0.1, gamma=0.9, epsilon=0.1, max_steps=100)
